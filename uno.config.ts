...
export default defineConfig({
    ...
    shortcuts: [{
        'container': 'bg-gray-1 dark:bg-dark-2 dark:color-gray-2 px-20 py-10 w-full h-full ',
        'layout': ' w-full h-full rd-5  flex relative  bg-white  dark:bg-dark-4   overflow-hidden  ',
        ...
        'chatitem': 'm-1  p-5 rd-2 color-gray-6 dark:color-gray-2 text-sm font-500 w-full ',
        'chattext': ' w-full resize-vertical b-none  dark:bg-dark-1 bg-gray-1  pl5 pr25 pt3 pb3 rd-2 h-full',
